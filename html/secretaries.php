...
<body>
        ...
        <div class="jumbotron">
            ...
            <ul class="nav nav-pills nav-justified" id="navLinks">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link active" href="#">Προσωπικό</a>
                ...
                <tbody>
                    <tr>
                        <th scope="row" id="no-border-top">
                            <img alt="teachers_Img" src="/assets/images/secretary.jpg" id="teacher_img">
                        </th>
    ...
    <!-- Begin of Footer -->
    <div class="d-flex justify-content-around bottomArea p-1 pb-2">
